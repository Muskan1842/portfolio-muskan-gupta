    ...
    return (
        <div className='flex justify-center w-1/2'>
            <div className=''>
                ...
                <img alt='profile-pic' src='https://portfolio-muskan-gupta.netlify.app/assets/profile-girl.png' className='w-80 rounded-full centric-shadow-profile-photo mt-20 ml-20'></img>
            </div>
        </div>
    )
}
